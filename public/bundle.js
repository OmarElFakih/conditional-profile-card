...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            <li><a href=${variables.twitter == null ? "" : variables.twitter}><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://github.com/${variables.github == null ? "" : variables.github}"><i class="fa fa-github"></i></a></li>
            <li><a href=${variables.linkedin == null ? "" : variables.linkedin}><i class="fa fa-linkedin"></i></a></li>
            <li><a href=${variables.instagram == null ? "" : variables.instagram}><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
